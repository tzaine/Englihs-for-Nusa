...
const About = () => {
  ...
  return (
    <div 
      ...
      style={{ height: '300vh' }}
    >
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="precision-assembly">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            <div className="flex items-center gap-4 mb-2 md:mb-2 pt-8 sm:pt-6 md:pt-4">
              <div className="atlas-chip opacity-0 animate-fade-in" style={{
                animationDelay: "0.1s"
              }}>
                <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-atlas-500 text-white mr-2">02</span>
                <span>Precision</span>
              </div>
            </div>
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-red-dark-1"
              ></div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Micro-precision assembly with sub-millimeter accuracy
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-red-dark-2"
              ></div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Adaptive intelligence for complex manufacturing processes
                  </h3>
                </div>
              </div>
            </div>
            ...
            >
              <div
                className="absolute inset-0 z-0 bg-red-dark-3"
              ></div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Seamless integration into <span className="text-[#FC4D0A]">existing workflows</span>
                  </h3>
                </div>
              </div>
            </div>
