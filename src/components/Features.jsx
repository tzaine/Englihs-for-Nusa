  ...
  return (
    <div 
      ...
      className={cn(
        ...
        "lg:hover:bg-gradient-to-br lg:hover:from-white lg:hover:to-atlas-50",
        "transition-all duration-300"
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
      <div className="rounded-full bg-atlas-50 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center text-atlas-500 mb-4 sm:mb-5">
        {icon}
      </div>
      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          <div className="atlas-chip mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-atlas-500 text-white mr-2">03</span>
            <span>Features</span>
          </div>
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Precision Engineering, <br className="hidden sm:block" />Intelligent Assembly
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Advanced robotics designed for manufacturing excellence, combining precision mechanics with AI-driven adaptability.
          </p>
        </div>
